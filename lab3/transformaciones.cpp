...
void animacion(){
	...
	beta += (delta/5.0f) * glm::radians(1.0f);
	...
	scene.meshes[0]->model_transform = 
		...
		glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, -forward)) *
		glm::scale(glm::mat4(1.0f), glm::vec3(0.4f, 0.4f, 0.4f));
	
	scene.meshes[1]->model_transform = 
		glm::translate(glm::mat4(1.0f), glm::vec3(3.0f, 0.0f, 0.0f)) *
		glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, -forward)) *
		glm::rotate(glm::mat4(1.0f), beta, glm::vec3(0.0f, 0.0f, 1.0f)) *
		glm::scale(glm::mat4(1.0f), glm::vec3(0.4f, 0.4f, 0.4f));
	...
	scene.meshes[5]->model_transform = 
		glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, -3.0f)) *
		glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, -forward)) *
		glm::rotate(glm::mat4(1.0f), beta, glm::vec3(0.0f, 0.0f, 1.0f)) *
		glm::scale(glm::mat4(1.0f), glm::vec3(0.4f, 0.4f, 0.4f));
	
	scene.meshes[6]->model_transform = 
		glm::translate(glm::mat4(1.0f), glm::vec3(5.0f, 0.0f, 5.0f)) *
		glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, -forward)) *
		glm::scale(glm::mat4(1.0f), glm::vec3(0.4f, 0.4f, 0.4f));
	
	scene.meshes[7]->model_transform = 
		glm::translate(glm::mat4(1.0f), glm::vec3(5.0f, 0.0f, 5.0f)) *
		glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, -forward)) *
		glm::rotate(glm::mat4(1.0f), beta, glm::vec3(0.0f, 0.0f, 1.0f)) *
		glm::scale(glm::mat4(1.0f), glm::vec3(0.4f, 0.4f, 0.4f));
		
	scene.meshes[8]->model_transform = 
		glm::translate(glm::mat4(1.0f), glm::vec3(-5.0f, 0.0f, 5.0f)) *
		glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, -forward)) *
		glm::scale(glm::mat4(1.0f), glm::vec3(0.4f, 0.4f, 0.4f));
	
	scene.meshes[9]->model_transform = 
		glm::translate(glm::mat4(1.0f), glm::vec3(-5.0f, 0.0f, 5.0f)) *
		glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, -forward)) *
		glm::rotate(glm::mat4(1.0f), beta, glm::vec3(0.0f, 0.0f, 1.0f)) *
		glm::scale(glm::mat4(1.0f), glm::vec3(0.4f, 0.4f, 0.4f));
...
bool init_resources(){
    ...
    scene.meshes[0] = leerOFF("avion.off"); 
    scene.meshes[1] = leerOFF("helice.off");
	
    scene.meshes[2] = leerOFF("avion.off"); 
	scene.meshes[3] = leerOFF("helice.off");
	
	scene.meshes[4] = leerOFF("avion.off"); 
	scene.meshes[5] = leerOFF("helice.off"); 
	
	scene.meshes[6] = leerOFF("avion.off"); 
	scene.meshes[7] = leerOFF("helice.off"); 
	
	scene.meshes[8] = leerOFF("avion.off"); 
	scene.meshes[9] = leerOFF("helice.off"); 
	...
	init_buffers(scene.meshes[6]);
	init_buffers(scene.meshes[7]);
	init_buffers(scene.meshes[8]);
	init_buffers(scene.meshes[9]);
